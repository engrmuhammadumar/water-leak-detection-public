...
def main():
    ...
    plt.savefig(os.path.join(OUT_DIR, "loss_curve.png"), bbox_inches="tight"); plt.close()
    ...
    plt.legend(); plt.tight_layout()
    plt.savefig(os.path.join(OUT_DIR, "accuracy_curve.png"), bbox_inches="tight"); plt.close()

    print("Saved curves to outputs/")
